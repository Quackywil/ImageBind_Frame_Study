...
%% Instructions
% Additional instruction message
instructionMessage = 'The experiment should only take approximately 5 minutes. \nAny questions?';
instructionTextSize = 50;  % Adjust the text size as needed
instructionTextColor = [255 255 255];  % White color
...
%     end
    ...
    dataMatrix{trialNumber, 18} = responseTime; % Response time
end
