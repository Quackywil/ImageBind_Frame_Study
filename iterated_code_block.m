...
% Will
% Frame Study: How well do participants associate a static visual object image frames with an
% auditory ImageBind embedding of a 2 second audio sample?
...
for trialNumber = 1:length(dataMatrix)
    ...
    while true
        ...
        if pressed && (firstPress(leftKey) || firstPress(rightKey))
            break;
        end
    end
